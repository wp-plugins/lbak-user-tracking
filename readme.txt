...
* Added the ability to stop tracking guest users.

* Added to ability to delete all guest user records in the database.
...
* Implemented User Login Stats with .csv exporting. Kudos to Hilary.
