...
function lbakut_option_translate($k) {
    switch($k) {
        ...
        case 'track_ignore_admin': return '<b>Don\'t track admins</b>';
        ...
        case 'widget_show_page_title': return 'Page Title';
        ...
        case 'search_show_page_title': return 'Page Title';
...
function lbakut_option_description($k) {
    ...
    switch($k) {
        ...
        case 'track_ignore_admin': return 'Check this to disable the tracking
            of admin users.';
